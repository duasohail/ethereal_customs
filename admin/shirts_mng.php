                    ...
                    <div class="card-body">
                        <form action= "" method="post" enctype="multipart/form-data">
                            ...
                            <table width="100%" border="1px" class="table table-responsive-sm table-responsive-lg">
                                <tr>
                                    <td width="90%"> <img src="../images/<?php echo $img; ?>" width="70px" height="70px"> </td>
                                    <td><a href="delete_shirts.php?delete=<?php echo $serial1;?>" class="btn btn-outline-dark "> DELETE </a></td>
                                <tr>
                            </table>
